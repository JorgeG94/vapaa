...
void C_MPI_File_read_at(int * file_f, size_t * offset_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
...
#ifdef HAVE_CFI
void CFI_MPI_File_read_at(int * file_f, size_t * offset_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
void C_MPI_File_read_at_all(int * file_f, size_t * offset_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
#ifdef HAVE_CFI
void CFI_MPI_File_read_at_all(int * file_f, size_t * offset_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
void C_MPI_File_write_at(int * file_f, size_t * offset_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
#ifdef HAVE_CFI
void CFI_MPI_File_write_at(int * file_f, size_t * offset_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
void C_MPI_File_write_at_all(int * file_f, size_t * offset_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
#ifdef HAVE_CFI
void CFI_MPI_File_write_at_all(int * file_f, size_t * offset_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
void C_MPI_File_read(int * file_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
#ifdef HAVE_CFI
void CFI_MPI_File_read(int * file_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
void C_MPI_File_read_all(int * file_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
#ifdef HAVE_CFI
void CFI_MPI_File_read_all(int * file_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
void C_MPI_File_write(int * file_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
#ifdef HAVE_CFI
void CFI_MPI_File_write(int * file_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
void C_MPI_File_write_all(int * file_f, void * buffer, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
...
#ifdef HAVE_CFI
void CFI_MPI_File_write_all(int * file_f, CFI_cdesc_t * desc, int * count_f, int * datatype_f, struct F_MPI_Status * status_f, int * ierror)
{
    const bool need_status = !C_IS_MPI_STATUS_IGNORE(status_f);
    MPI_Status status;
    MPI_File file = C_MPI_FILE_F2C(*file_f);
